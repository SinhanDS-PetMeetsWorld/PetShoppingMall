...
public class regist {
	...
	public void regist_product() throws Exception{
		RequestBuilder req = MockMvcRequestBuilders.post("/seller/product/regist.do")
				...
				.param("brand", "jeju")
				.param("title_list", "사이즈")
				.param("content_list", "small")
				.param("price_list", "500")
				.param("title_list", "사이즈")
				.param("content_list", "middle")
				.param("price_list", "1000")
				.param("title_list", "사이즈")
				.param("content_list", "large")
				.param("price_list", "2000")
				.param("discount", "0")
//				.param("image_url", "")
				.param("description", "");
