...
public class MvcConfig implements WebMvcConfigurer{
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(userLoginIntercepton())
						...
						.excludePathPatterns("/user/findIdPage.do")
						.excludePathPatterns("/user/findPwdPage.do");
		...
		registry.addInterceptor(sellerLoginIntercepton())
						...
						.excludePathPatterns("/seller/findId.do")
						.excludePathPatterns("/seller/findPwd.do")
						.excludePathPatterns("/seller/findIdPage.do")
						.excludePathPatterns("/seller/findPwdPage.do");
