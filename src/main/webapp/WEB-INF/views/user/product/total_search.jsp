...
<head> 
    <meta charset="utf-8">
    <title>Pet Meets World:: 상품</title>
        ...
        <div class="contents">
			...
			<div class="contentsright">
				...
				<div>
					...
					<a href="list.do?category1=0&totalSearchWord=${ProductSearchVO.totalSearchWord}"><h2>${catekor.category_name[0]} (총 ${product_count0}건)</h2>  > 보러가기</a><br>
				...
				<div>
					...
					<a href="list.do?category1=1&totalSearchWord=${ProductSearchVO.totalSearchWord}"><h2>${catekor.category_name[1]} (총 ${product_count1}건)</h2>  > 보러가기</a><br>
				...
				<div>
					...
					<a href="list.do?category1=2&totalSearchWord=${ProductSearchVO.totalSearchWord}"><h2>${catekor.category_name[2]} (총 ${product_count2}건)</h2>  > 보러가기</a><br>
